...
-- Généré le : jeu. 09 juin 2022 à 04:33
...
(1, 'WEB', '', 1, 'thumbnail_20220527_091156_629cb0598e7ec.jpg', '2022-06-03 20:18:13');
...
(1, 'électronique', 'Programmation de circuits électroniques, Conception et mise en oeuvre d\'appareils électroniques, Utilisation des composants CMS, Lecture de documents constructeurs (généralement en anglais).', 1, '2022-06-03 20:42:02'),
(2, 'informatique', 'Langages : C, C++, PHP, xml, java, javascript, html, CSS.\r\nLogiciels : Eclipse, Netbeans, android-studio, visual studio code, sublime text, Git, Docker.\r\nSGBD : Utilisation d\'une base de données (MySQL, Oracle, PostgreSQL, java DB, SQLite).\r\nSystèmes d\'exploitation : MSDOS, WINDOWS, LINUX.', 1, '2022-06-03 20:42:14');
...
INSERT INTO `cv` (`id_cv`, `title_cv`, `nom_cv`, `src_cv`, `id_user`, `date_cv`) VALUES
(4, 'stage développeur web', 'stage développeur web', 'Copie de Développeur web V2-1_629ecff8c3969.pdf', 1, '2022-06-07 04:11:36');
...
(3, 'électronique', 'Réparation d\'appareils d\'électroniques (ordinateurs fixes et portables, téléviseurs, etc..).', 1, '2022-06-07 02:50:09'),
(4, 'forum', '8/2014 - 1/2017 : Aide sur les forum d\'openclassrooms (aider, écouter et trouver des solutions).', 1, '2022-06-07 02:50:31'),
(5, 'languages', 'Le C, C++, nodeJS, Angular, docker, git en Autodidacte.', 1, '2022-06-07 02:50:54');
...
(5, 'naulot', 'ludovic', 'amitie58@live.fr', 'fggfgf', 'fggfgfggfgfg', 1, '2022-06-07 20:37:55');
...
INSERT INTO `parcours` (`id_parcours`, `nom_parcours`, `title_parcours`, `entreprise_parcours`, `date_debut_parcours`, `date_fin_parcours`, `type_parcours`, `lieu_parcours`, `description_parcours`, `in_progress_parcours`, `id_user`, `date_parcours`) VALUES
(8, 'BTS Electronique', 'BTS Electronique', 'Lycée Jules Renard', '2002-09-06 00:00:00', '2004-06-06 00:00:00', '', 'Nevers', 'Programmation de circuits électroniques, Conception et mise en oeuvre d\'appareils électroniques, Utilisation des composants CMS, Lecture de documents constructeurs (généralement en anglais).', 0, 1, '2022-06-06 09:37:09'),
(9, 'Bachelor 3 informatique', 'Bachelor 3 informatique', 'CS2I', '2011-09-06 00:00:00', '2012-06-06 00:00:00', '', 'Nevers', 'Langages : C, C++, PHP, xml, java, javascript, html, CSS.\r\nLogiciels : Eclipse, Netbeans, android-studio, visual studio code, sublime text, Git, Docker.\r\nSGBD : Utilisation d\'une base de données (MySQL, Oracle, PostgreSQL, java DB, SQLite).\r\nSystèmes d\'exploitation : MSDOS, WINDOWS, LINUX.', 0, 1, '2022-06-06 09:38:56'),
(10, 'ITIL Foundation V3', 'ITIL Foundation V3', 'IT Servive Management', '2019-03-06 00:00:00', '2019-03-06 00:00:00', '', 'Lyon', '1 semaine.', 0, 1, '2022-06-06 09:40:32'),
(11, 'Monteur - Installateur de matériel d\'alarme et de vidéo surveillance', 'Monteur - Installateur de matériel d\'alarme et de vidéo surveillance', 'ATN', '2006-06-06 00:00:00', '2007-02-06 00:00:00', '', 'Nevers', 'Tirage de lignes et câblage. Choix de l\'emplacement du matériel et mise en place du matériel. Programmation, tests et réglages. Explication du fonctionnement et\r\nmaintenance du matériel.', 0, 1, '2022-06-06 09:42:47'),
(12, 'Technicien de maintenance informatique et bureautique', 'Technicien de maintenance informatique et bureautique', 'SARL NEVERS LAN', '2011-06-06 00:00:00', '2011-07-06 00:00:00', '', 'Fourchambault', '', 0, 1, '2022-06-06 09:44:06'),
(13, 'Technicien informatique(Stage et Adecco)', 'Technicien informatique(Stage et Adecco)', 'TECHNICENTRE Auvergne Nivernais', '2012-02-06 00:00:00', '2012-12-06 00:00:00', '', 'Nevers', 'Développement et maintenance de programmes en VBA.', 0, 1, '2022-06-06 09:45:44'),
(14, 'Technicien informatique et telecom', 'Technicien informatique et telecom', 'NEOSERV', '2015-02-06 00:00:00', '2015-03-06 00:00:00', '', 'Nevers', 'Installation et dépannage modem de ligne internet et configuration de pc.\r\nCours informatique. Migration monétique (carte bancaire).', 0, 1, '2022-06-06 09:47:08'),
(15, 'Technicien support (déploiement)', 'Technicien support (déploiement)', 'intérimaire', '2015-09-06 00:00:00', '2015-11-06 00:00:00', '', 'Nevers', 'Déploiement des postes Windows :\r\n    =&gt; DALKIA de nevers et decize. (Lynx RH)\r\n    =&gt; MGEN de nevers et moulins.  (pour Ergalis IT)\r\n    =&gt; SITA à nevers. (Ergalis IT)', 0, 1, '2022-06-06 09:48:43'),
(16, 'Développeur d\'applications et technicien hotline niveau 1 et 2', 'Développeur d\'applications et technicien hotline niveau 1 et 2', 'Réseau canopé', '2017-01-06 00:00:00', '2019-03-06 00:00:00', '', 'Moulins', 'Assistance utilisateur hotline niveau 1 et 2 (osTicket). Gestion des codes barres. Gestion du parc des tablettes. Développement PHP / MySQL / Javascript / html5 / CSS, java, nodeJS, Angular. Conversion des bases documentaires.', 0, 1, '2022-06-06 09:49:58'),
(18, 'Titre de développeur Web et Web mobile (Niveau 5, anc III)', 'Titre de développeur Web et Web mobile (Niveau 5, anc III)', 'onlineFormation (Access Code School)', '2022-03-07 00:00:00', '0000-00-00 00:00:00', '', 'Nevers', '', 1, 1, '2022-06-08 17:09:59');
...
--
ALTER TABLE `cat_produit`
  MODIFY `id_cat_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `competences_logo`
  MODIFY `id_competences_logo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `formations`
  MODIFY `id_fomations` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `framework_produit`
  MODIFY `id_framework_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `language_produit`
  MODIFY `id_language_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
...
--
ALTER TABLE `photos`
  MODIFY `id_photo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

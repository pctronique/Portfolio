...
-- Généré le : mar. 07 juin 2022 à 04:15
...
(3, 'maquette jadoo', 'Description du produit.', '', 1, '2022-06-06 15:50:36'),
(4, 'ACS Voyages', 'Description du produit.', '', 1, '2022-06-06 15:51:33'),
(5, 'Springfield', 'Description du produit.', '', 1, '2022-06-06 15:51:58');
...
(1, 'root', 'root', 'root', 'signe-github_1_629cb13b3dc11.png', 'root@root.fr', 'TmpKMmNCRjI2V2NPU0xCMQ$Gi6Ucz29Na2efDYcEgyx+7s5TT2VHpSiWYx8qo546T4', 'bonjour', 1, '2022-06-02 07:30:10');
...
--
ALTER TABLE `cat_produit`
  MODIFY `id_cat_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `formations`
  MODIFY `id_fomations` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT pour la table `framework`
--
ALTER TABLE `framework`
  MODIFY `id_framework` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `framework_produit`
--
ALTER TABLE `framework_produit`
  MODIFY `id_framework_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `language_produit`
  MODIFY `id_language_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `parcours`
  MODIFY `id_parcours` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

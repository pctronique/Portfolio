...
-- Généré le : jeu. 09 juin 2022 à 14:28
...
(1, 'WEB', '', 1, 'thumbnail_20220527_091156_629cb0598e7ec.jpg', 1, '2022-06-03 20:18:13'),
...
--
ALTER TABLE `cat_produit`
  MODIFY `id_cat_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `formations`
  MODIFY `id_fomations` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `language_produit`
  MODIFY `id_language_produit` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
